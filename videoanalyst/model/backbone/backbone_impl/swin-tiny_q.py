...
class SwinTransformerTQ(ModuleBase):
    ...
    def __init__(self,
                 ...
                 frozen_stages=-1,
                 use_checkpoint=False):
        super(SwinTransformerTQ, self).__init__()
    ...
    def forward(self, x, out_indices=None, reshape=True):
        ...
        # mask_index = self.proj_fg_bg_label_map(mask_index)
        # mask_index = mask_index.flatten(2).transpose(1, 2)
        # x += mask_index
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerTQ, self).train(mode)
        _freeze_stages(self, self.frozen_stages, self.ape)



    def update_params(self):
        self.init_weights('https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth')
