...
def build_concatenated_fusion_encoder(config, drop_path_allocator,
    ...
    if config['absolute']:
        ...
        untied_pre_z_pos_enc = Untied2DPositionalEncoder(dim, num_heads, x_shape[0], x_shape[1])
    ...
    num_encoders = config['encoder_layer']
    encoder_modules = []
    ...
    encoder = ConcatenatedFusion(encoder_modules, untied_z_pos_enc, untied_pre_z_pos_enc, untied_x_pos_enc,
